...
Unes's robot measures just a few centimeters tall and is crafted primarily from simple, inexpensive materials like cardboard, hot glue, and basic tools. The use of such readily available supplies demonstrates that creating functional robotics doesn't require expensive 3D printers or specialized parts.
...
💡 Join our [Discord Server](https://discord.com/invite/8ahXACdamN) to see images from the robot and connect with the community!
